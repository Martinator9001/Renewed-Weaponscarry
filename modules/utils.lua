...
local playerSlots = {
    ...
    { -- Pistol Thigh
		{ bone = 51826, pos = vec3(0.083041, 0.068614, 0.091040), rot = vec3(-124.852936, 5.241456, -2.311053) },
        { bone = 58271, pos = vec3(0.083041, 0.068614, -0.101040), rot = vec3(-64.852936, 5.241456, -2.311053) },
    },
}
